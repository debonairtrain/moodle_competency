                                ...
                                foreach ($maximum as $show_result) {
                                    ...
                                    $minimum = $DB->get_record_sql("SELECT c.id AS cid,
                                            ...
                                            $competency = $DB->get_records_sql("SELECT
                                                  ...
                                                  FROM mdl_competency AS comp
                                                  INNER JOIN mdl_competency_framework AS f ON comp.competencyframeworkid = f.id
                                                  INNER JOIN mdl_competency_modulecomp AS mcomp ON mcomp.competencyid = comp.id
                                                  LEFT JOIN mdl_competency_coursecomp AS cccomp ON cccomp.competencyid = comp.id
                                                  INNER JOIN mdl_course AS cp ON cccomp.courseid = cp.id
